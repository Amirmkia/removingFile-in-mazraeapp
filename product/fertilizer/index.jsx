...
const Fertilizer = ({data}) => {
  ...
  return (
    <>
      ...
      <div className="d-flex flex-row position-relative shop-product-createdDay">
        <p>تاریخ انقضا:</p>
        <p className="shop-product-createdDay-day">{data.expire_year}</p>
      </div>
      <div className="d-flex flex-row position-relative shop-product-createdDay">
        <p>موجودی:</p>
      ...
      <div className="d-flex flex-row position-relative shop-product-createdDay">
        <p>نوع :</p>
        <p className="shop-product-createdDay-day">{data.type}</p>
      </div>
      <div className="d-flex flex-row position-relative shop-product-createdDay">
        <p>وزن بسته بندی:</p>
        <p className="shop-product-createdDay-day">
          {data.quantity_pack} {data.quantity_pack_unit}
        </p>
      </div>
      <div className="d-flex flex-row position-relative shop-product-createdDay">
        <p>شرکت تولیدکننده:</p>
